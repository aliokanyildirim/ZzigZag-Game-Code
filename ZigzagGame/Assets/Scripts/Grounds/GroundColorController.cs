...
public class GroundColorController : MonoBehaviour
{
    ...
    [SerializeField] private Color[] colors; // renkleri gireceðiz

    private int colorIndex = 0;   // renklerde gezmesini saðlayacaðýz.
    [SerializeField] private float lerpValue;

    [SerializeField] private float time; // zamanlayýcý oluþturacaðýz.
